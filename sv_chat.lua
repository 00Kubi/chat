...
-- Chat callout roli
-- QBCore.Functions.CreateCallback('chat:server:getPlayerRole', function(source, db))
--     local player = QBCore.Functions.GetPlayer(source)
--     local role = "Gracz" -- domyslna rola

--     if IsPlayerAceAllowed(source, "command") then
--         if IsPlayerAceAllowed(source, "group.owner") then
--             role = "Wlasciciel"
--         elseif IsPlayerAceAllowed(source, "group.support") then
--             role = "Support"
--         end
--     end
